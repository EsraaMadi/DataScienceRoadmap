...
with col:
    ...
    st.info(' DUNKIN في الدور الأرضي قرب المصاعد ممر  A :dunkin:', icon="☕")
    st.info(' Subway في الدور الأرضي ممر  C', icon="🥙")
    st.info(' استراحة الرجال في الدور الأرضي ممر  C 👨🏼', icon="🛋️")
    st.info(' استراحة النساء في الدور الأرضي ممر  C 👩🏼', icon="🛋️")
    st.markdown('#')
    st.markdown('#')
